...
```bash
git clone https://github.com/songblaq/oh-my-brain.git ~/_/projects/oh-my-brain
cd ~/_/projects/oh-my-brain/views/owl
...
| 항목 | 동기화? | 비고 |
|---|---|---|
| `~/_/projects/oh-my-brain/` | ✗ (git 로 관리) | 각자 clone |
...
- **Primary**: `LucaBlaiMacmini` (Mac mini, macOS 26.3, arm64, Python 3.14.3)
  ...
  - project repo: `/Users/lucablaq/_/projects/oh-my-brain`
