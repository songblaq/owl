...
- **LAYER 1 — SPEC**: `~/_/projects/agent-brain/views/owl/` (정책 문서 + Python 소스)
...
전체 파일 계약은 `~/_/projects/agent-brain/views/owl/AGENTS.md` 에 정의되어 있다.
...
핵심 정책은 `~/_/projects/agent-brain/views/owl/docs/` 에 있다. 자주 참조:
