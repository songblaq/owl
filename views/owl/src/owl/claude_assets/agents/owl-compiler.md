...
- `~/_/projects/oh-my-brain/views/owl/AGENTS.md` §5 — Compiled Summary contract, Compiled Note contract
- `~/_/projects/oh-my-brain/views/owl/docs/karpathy-ingest-rules-v0.md` — raw → compiled rules
- `~/_/projects/oh-my-brain/views/owl/docs/compiled-format-spec-v0.md` — required headers and section structure
- `~/_/projects/oh-my-brain/views/owl/docs/wiki-maintenance-spec-v0.md` — when to also create note vs concept
- `~/_/projects/oh-my-brain/views/owl/docs/incremental-maintenance-spec-v0.md` — which existing compiled docs may need updating
