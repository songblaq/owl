...
- `~/_/projects/oh-my-brain/views/owl/docs/health-check-spec-v0.md` — definition of all 8 rules and what they mean
- `~/_/projects/oh-my-brain/views/owl/docs/wiki-maintenance-spec-v0.md` — how to fix each issue type
- `~/_/projects/oh-my-brain/views/owl/docs/compiled-format-spec-v0.md` — required document structure
- `~/_/projects/oh-my-brain/views/owl/AGENTS.md` §6 — link contract
