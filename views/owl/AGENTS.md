...
- **프로젝트 디렉토리**: `~/_/projects/oh-my-brain/views/owl`
...
- 프로젝트: `~/_/projects/oh-my-brain/views/owl`
...
- 위 4개 항목은 코드 없음 — `~/_/projects/oh-my-brain/views/owl/src/owl/` 의 로직을 호출만 함
...
- vault 안에 Python/실행 코드를 두지 않는다 (4계층 invariant). 모든 로직은 `~/_/projects/oh-my-brain/views/owl/src/owl/` 에.
